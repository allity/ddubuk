...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.CustomViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final CustomAdapter.CustomViewHolder holder, final int position) {
        holder.tv_Customname.setText(arrayList.get(position).getName());
        holder.tv_Customregion.setText(arrayList.get(position).getRegion());
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public CustomViewHolder(@NonNull View itemView) {
            ...
            tv_Customname = itemView.findViewById(R.id.tv_customname);
            tv_Customregion = itemView.findViewById(R.id.tv_customregion);
