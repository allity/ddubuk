...
public class SeotopAdapter extends RecyclerView.Adapter<SeotopAdapter.SeotopViewHolder> {
    MainActivity ma = new MainActivity();

    private ArrayList<Seotop> arrayList;
    private Context context;

    public SeotopAdapter(ArrayList<Seotop> arrayList, Context context) {
    ...
    @NonNull
    @Override
    public SeotopAdapter.SeotopViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_seotop, parent, false);
        SeotopAdapter.SeotopViewHolder holder = new SeotopAdapter.SeotopViewHolder(view);

        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull final SeotopAdapter.SeotopViewHolder holder, final int position) {
        holder.tv_Seotopname.setText(arrayList.get(position).getName());
        holder.tv_Seotopregion.setText(arrayList.get(position).getRegion());
    ...
    public class SeotopViewHolder extends RecyclerView.ViewHolder {
        TextView tv_Seotopname;
        TextView tv_Seotopregion;
        ImageButton btn_bookmark;
        ImageButton btn_bookmark2;

        public SeotopViewHolder(@NonNull View itemView) {
            super(itemView);

            tv_Seotopname = itemView.findViewById(R.id.tv_seotopname);
            tv_Seotopregion = itemView.findViewById(R.id.tv_seotopregion);
